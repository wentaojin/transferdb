...
type IncrSyncMeta struct {
	...
	SchemaNameS string `gorm:"not null;index:idx_dbtype_st_map,unique;comment:'源端 schema'" json:"source_schema_name"`
	TableNameS  string `gorm:"not null;index:idx_dbtype_st_map,unique;comment:'源端表名'" json:"source_table_name"`
