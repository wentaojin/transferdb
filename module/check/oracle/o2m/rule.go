...
func OracleTableColumnMapRuleCheck(
	...
	mysqlCharacterSet = common.MigrateTableStructureDatabaseCharsetMap[common.TaskTypeOracle2MySQL][oracleColInfo.CharacterSet]
	mysqlCollation = common.MigrateTableStructureDatabaseCollationMap[common.TaskTypeOracle2MySQL][oracleColInfo.Collation][mysqlCharacterSet]
