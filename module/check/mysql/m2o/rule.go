...
func MySQLTableColumnMapRuleCheck(
	...
	oracleCharacterSet = common.MigrateTableStructureDatabaseCharsetMap[common.TaskTypeMySQL2Oracle][mysqlColInfo.CharacterSet]

	oracleCollation = strings.Split(common.MigrateTableStructureDatabaseCollationMap[common.TaskTypeMySQL2Oracle][mysqlColInfo.Collation][common.StringUPPER(oracleCharacterSet)], "/")[0]
