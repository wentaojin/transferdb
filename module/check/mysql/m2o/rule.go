...
func MySQLTableColumnMapRuleCheck(
	...
	oracleCharacterSet = strings.ToLower(common.MigrateTableStructureDatabaseCharsetMap[common.TaskTypeMySQL2Oracle][mysqlColInfo.CharacterSet])

	oracleCollation = strings.Split(strings.ToLower(common.MigrateTableStructureDatabaseCollationMap[common.TaskTypeMySQL2Oracle][mysqlColInfo.Collation][common.StringUPPER(oracleCharacterSet)]), "/")[0]
